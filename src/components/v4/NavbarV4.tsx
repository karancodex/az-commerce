...
const NavbarV4 = () => {
    ...
    const products = [
        { name: "POS Billing", desc: "Omnichannel checkout solution", icon: ShoppingCart, href: "/v4/products/pos" },
        { name: "Inventory", desc: "Real-time stock management", icon: Box, href: "/v4/products/inventory" },
        { name: "Web Builder", desc: "E-commerce store builder", icon: Globe, href: "/v4/products/web" },
        { name: "Vendor System", desc: "Multi-vendor management", icon: Store, href: "/v4/products/vendor" },
        { name: "Delivery", desc: "Live order tracking", icon: Truck, href: "/v4/products/delivery" },
        { name: "Mobile Apps", desc: "Customer & Admin apps", icon: Smartphone, href: "/v4/products/mobile" },
        { name: "Analytics", desc: "Deep business insights", icon: PieChart, href: "/v4/products/analytics" },
        { name: "CRM", desc: "Customer relationships", icon: Users, href: "/v4/products/crm" },
    ];
                        ...
                        >
                            <div className="space-y-6 pb-6">
                                ...
                                <div className="flex flex-col gap-4 px-2">
                                    <Link href="/v4/industries" className="text-base font-bold text-[#0f172a]">Industries</Link>
                                    <Link href="/v4/pricing" className="text-base font-bold text-[#0f172a]">Pricing</Link>
                                    <Link href="/v4/resources" className="text-base font-bold text-[#0f172a]">Resources</Link>
                                    <hr className="border-slate-100" />
                                    <Link href="/v4/login" className="text-base font-bold text-[#0f172a]">Login</Link>
                                </div>
                            </div>
                        </motion.div>
                    )}
