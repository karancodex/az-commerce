    ...
    const columns = [
        {
            title: "Products",
            links: [
                { name: "POS Billing", href: "/v4/products/pos" },
                { name: "Inventory Management", href: "/v4/products/inventory" },
                { name: "E-commerce Builder", href: "/v4/products/web" },
                { name: "Vendor System", href: "/v4/products/vendor" },
                { name: "Delivery Tracking", href: "/v4/products/delivery" },
                { name: "Mobile Apps", href: "/v4/products/mobile" }
            ]
        },
        {
            title: "Industries",
            links: [
                { name: "Grocery Stores", href: "/v4/industries/grocery" },
                { name: "Restaurants", href: "/v4/industries/restaurant" },
                { name: "Pharmacies", href: "/v4/industries/pharmacy" },
                { name: "Retail Shops", href: "/v4/industries/retail" },
                { name: "Distributors", href: "/v4/industries/distributor" }
            ]
        },
        {
            title: "Resources",
            links: [
                { name: "Documentation", href: "/v4/docs" },
                { name: "API Reference", href: "/v4/api" },
                { name: "Help Center", href: "/v4/support" },
                { name: "Community", href: "/v4/community" },
                { name: "Video Tutorials", href: "/v4/tutorials" }
            ]
        },
        {
            title: "Company",
            links: [
                { name: "About Us", href: "/v4/about" },
                { name: "Careers", href: "/v4/careers" },
                { name: "Press Kit", href: "/v4/press" },
                { name: "Contact", href: "/v4/contact" },
                { name: "Partners", href: "/v4/partners" }
            ]
        }
    ];
