...
const Footer = () => {
    const footerLinks = {
        Product: [
            { name: "Website Builder", href: "/product/website-builder" },
            { name: "POS Billing", href: "/product/pos-billing" },
            { name: "Inventory", href: "/product/inventory" },
            { name: "Marketplace", href: "/product/marketplace" },
            { name: "Delivery Tracking", href: "/product/delivery-tracking" }
        ],
        Solutions: [
            { name: "Retail", href: "/solutions/retail" },
            { name: "E-commerce", href: "/solutions/e-commerce" },
            { name: "D2C Brands", href: "/solutions/d2c-brands" },
        ...
        Resources: [
            ...
            { name: "Partner Program", href: "/resources/partner-program" }
        ],
        Legal: [
